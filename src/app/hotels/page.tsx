            ...
            {hotels.map((hotel) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-display text-xl font-bold text-gray-900 mb-1 group-hover:text-[#002967] transition-colors">
                    {hotel.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <button className="bg-[#004b9d] text-white px-6 py-2 rounded-full hover:bg-sky-700 transition-all font-medium text-sm">
                      View Details
                    </button>
                  </div>
                </div>
