      ...
      <div className="relative h-[500px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 max-w-7xl mx-auto">
          <div className="flex items-center space-x-3 mb-4">
            <span className="px-4 py-2 bg-[#004b9d] rounded-full text-white text-sm font-medium">
              {pkg.category}
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  {pkg.itinerary.map((day, index) => (
                    <div key={index} className="flex space-x-6">
                      <div className="flex-shrink-0">
                        <div className="w-16 h-16 bg-[#004b9d] text-white rounded-full flex items-center justify-center font-display font-bold text-lg">
                          {day.day}
                        </div>
                      </div>
            ...
            <div>
              <div className="sticky top-24 space-y-6">
                {/* Booking Card */}
                <div className="bg-[#004b9d] text-white rounded-2xl p-6">
                  ...
                  <Link
                    href="/contact"
                    className="block w-full bg-white text-[#1a4f9d] py-4 rounded-full font-bold text-center hover:bg-gray-100 transition-colors mb-3"
                  >
                    Book Now
                  </Link>
                ...
                <div className="bg-gray-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <svg
                        className="w-5 h-5 text-[#002967] mr-2"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
