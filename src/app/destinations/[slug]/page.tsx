...
export default function DestinationDetailPage({ params }: { params: { slug: string } }) {
  ...
  const relatedPackages = tourPackages.filter(pkg => 
    pkg.highlights.some(h => h.toLowerCase().includes(destination.name.toLowerCase()))
  );
    ...
    <div>
      ...
      <div className="relative h-[500px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 max-w-7xl mx-auto">
          <div className="inline-block px-4 py-2 bg-amber-600 rounded-full text-white text-sm font-medium mb-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Top Attractions */}
              <div className="mb-12">
                <h2 className="font-display text-3xl font-bold mb-6">Top Attractions</h2>
              ...
              <div>
                <h2 className="font-display text-3xl font-bold mb-6">Available Activities</h2>
                <div className="flex flex-wrap gap-3">
                  {destination.activities.map((activity, index) => (
                    <span 
                      key={index}
                      className="px-4 py-2 bg-white border-2 border-amber-600 text-amber-700 rounded-full font-medium hover:bg-amber-600 hover:text-white transition-colors"
                    >
                      {activity}
                    </span>
                  ))}
            ...
            <div>
              <div className="sticky top-24 space-y-6">
                ...
                <div className="bg-gray-50 rounded-2xl p-6">
                  <h3 className="font-display text-xl font-bold mb-4">Quick Information</h3>
                ...
                {/* CTA Box */}
                <div className="bg-amber-600 text-white rounded-2xl p-6 text-center">
                  ...
                  <Link 
                    href="/contact"
                    className="block w-full bg-white text-amber-700 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors"
                  >
                    Contact Us
                  </Link>
                </div>
      ...
      {relatedPackages.length > 0 && (
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="font-display text-3xl font-bold mb-8">Related Tour Packages</h2>
