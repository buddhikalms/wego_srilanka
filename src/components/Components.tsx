        ...
        {showSearch && (
          <div className="max-w-2xl mx-auto animate-fade-in stagger-2">
            <div className="bg-white rounded-full shadow-2xl p-2 flex items-center">
              ...
              />
              <button className="bg-amber-600 text-white px-8 py-3 rounded-full hover:bg-amber-700 transition-all font-medium whitespace-nowrap">
                Search
              </button>
            </div>
          </div>
    ...
    <Link href={`/destinations/${destination.slug}`}>
      <div className="group relative overflow-hidden rounded-2xl shadow-lg hover-lift bg-white">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          <div className="inline-block px-3 py-1 bg-amber-600 rounded-full text-xs font-medium mb-2">
      ...
      <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover-lift">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
            ...
            <button className="text-amber-600 font-medium group-hover:text-amber-700 flex items-center">
              View Details
    ...
    <div className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link 
            href="/packages" 
            className="bg-white text-amber-700 px-8 py-4 rounded-full hover:bg-gray-100 transition-all font-semibold text-lg shadow-xl"
          >
            Browse Packages
          </Link>
          <Link 
            href="/contact" 
            className="bg-amber-600 text-white px-8 py-4 rounded-full hover:bg-amber-700 transition-all font-semibold text-lg shadow-xl"
          >
            Contact Us
          </Link>
        </div>
